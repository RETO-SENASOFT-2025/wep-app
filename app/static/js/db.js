    ...
    const SuperAppDB = {
        ...
        openDB() {
            return new Promise((resolve, reject) => {
                ...
                req.onsuccess = (e) => {
                    SuperAppDB.db = e.target.result;
                    resolve(SuperAppDB.db);
                };
        ...
        addConversation(title) {
            return new Promise((resolve, reject) => {
                ...
                const req = this.tx('conversations', 'readwrite').add({
            ...
            return new Promise((resolve, reject) => {
                ...
                cursorReq.onsuccess = (e) => {
                    ...
                    if (cursor) {
                        ...
                        resolve(results.sort((a, b) => (a.created_at || '').localeCompare(b.created_at || '')));
                    }
                };
        ...
        addMessage(chatId, text, role = 'user') {
            return new Promise((resolve, reject) => {
                const now = new Date().toISOString();
                const req = this.tx('messages', 'readwrite').add({
